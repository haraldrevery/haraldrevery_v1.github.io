// ========================================
// SEAMLESS PAGE TRANSITION SYSTEM (CLEANED & OPTIMIZED)
// ========================================
...
(function() {
  ...
  let activeObservers = []; // Tracks observers for cleanup
  ...
  // 3. RE-INITIALIZE (The Optimized Version)
  function reinitializeScripts() {
    ...
    // Re-initialize Observers (One set only)
    setTimeout(() => {
      ...
      activeObservers.push(textObserver);
  ...
  console.log('Optimized seamless transitions initialized');
})();
