 ...
 Save this file as .distpage-transitions.js
 Then add to all HTML pages script src=.distpage-transitions.jsscript
 ========================================
...
(function() {
  ...
  function reinitializeScripts() {
    ...
    if (typeof audioPlayer === 'function' && document.querySelector('[x-data]')) {
     ...
     Trigger scroll event to showhide navbar
    setTimeout(() = {
